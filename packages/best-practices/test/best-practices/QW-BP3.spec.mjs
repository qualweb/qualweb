...
buildTest('QW-BP3', [
  {
    path: '../fixtures/~bandrade/bp3/passed.html',
    outcome: 'passed'
  },
  {
    path: '../fixtures/~bandrade/bp3/failed.html',
    outcome: 'failed'
  },
  {
    path: '../fixtures/~bandrade/bp3/failed2.html',
    outcome: 'failed'
  },
  {
    path: '../fixtures/~bandrade/bp3/inapplicable.html',
